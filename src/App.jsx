...
function App() {
  ...
  return (
    ...
    <main class="flex-grow">
      ...
      <div id="home" class="relative text-blue-900 h-screen overflow-hidden animate__animated animate__fadeInDown">
        ...
        <div class="relative z-10 flex flex-col items-center justify-center h-full text-center p-6">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
                    <a href="/order" class="bg-blue-300 text-blue-900 py-3 px-8 rounded-lg text-lg font-medium hover:bg-blue-400 shadow-lg transition-bg">
                        Secure your card
                    </a>
                </div>
        </div>
      ...
      <section id="about" class="py-18 px-2 bg-gray-100 animate__animated animate__bounce">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-16">
                    <h2 class="text-3xl font-bold text-blue-900 mb-4">ClickSafe <span class="text-blue-400">Secure Cards </span> Features</h2>
                ...
                <div class="grid grid-cols-1 gap-8">
                    ...
                    <BsCreditCard class="text-4xl mb-3" />
                        <h3 class="text-xl font-bold text-blue-900 mb-3">Platinum Credit Card</h3>
                        <p class="text-blue-900 mb-4">Premium benefits with travel rewards and concierge service.</p>
                        <a href="/cards/platinum" class="text-gray-100 text-xl flex items-center gap-1 hover:text-blue-900">
                            Learn more
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                    ...
                    <div class="bg-blue-300 rounded-lg p-8">
                        ...
                        <h3 class="text-xl font-bold text-blue-900 mb-3">Business Expense Card</h3>
                        <p class="text-blue-900 mb-4">Real-time transaction with smart spending controls and expense reporting</p>
                        <a href="/cards/business" class="text-gray-100 text-xl flex items-center gap-1 hover:text-blue-900">
                            Learn more
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
    </svg>
                    ...
                    <div class="bg-blue-300 rounded-lg p-8">
                        <BsCreditCard class="text-4xl mb-3" />
                        <h3 class="text-xl font-bold text-blue-900 mb-3">Virtual Debit Card</h3>
                        <p class="text-blue-900 mb-4">Automatic instant digital card for online purchases with enhanced security.</p>
                        <a href="/cards/virtual" class="text-gray-100 text-xl flex items-center gap-1 hover:text-blue-900">
                            Learn more
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
    </svg>
       ...
       <div class="bg-blue-300 rounded-lg p-8">
                        ...
                        <h3 class="text-xl font-bold text-blue-900 mb-3">Rewards Mastercard</h3>
                        <p class="text-blue-900 mb-4">Earn cashback on every purchase with premium benefits.</p>
                        <a href="/cards/rewards" class="text-gray-100 text-xl flex items-center gap-1 hover:text-blue-900">
                            Learn more
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
    </svg>
      ...
      <section id="feature" class="py-8 px-2 bg-gray-100 mb-16 animate__animated animate__fadeIn">
  ...
  <div class="w-full h-full flex flex-col items-center py-10">
    <div
      ...
      <div class="w-full rounded-lg p-4">
        <h2 class="text-2xl font-semibold text-blue-900 items-center md:text-4xl">Advanced contactless technology.</h2>
        <p class="block items-center ml-0 mt-4 mb-8 px-4 py-6 text-blue-900 max-w-md">Our cards feature next-generation contactless payment technology for faster, more secure transactions. Tap to pay with enhanced encryption and transaction limits to protect your funds.</p>
          <button class="bg-blue-300 text-center text-blue-900 px-4 py-2 rounded-xl hover:bg-blue-400" onClick={() => window.location.href = '/contactless'}>Explore ClickSafe
  </button>
      </div>
    </div>
    <div
      class="w-full mx-auto flex md:flex-row flex-col-reverse gap-2 justify-center mt-4">
      <div class="w-full rounded-lg p-4">
        <h2 class="text-3xl font-semibold text-blue-900 items-center md:text-4xl">Bank-level security.</h2>
        <p class="block items-center ml-0 mt-4 mb-8 px-4 py-6 text-blue-900 max-w-md">All our cards come with military-grade encryption, real-time fraud monitoring, and instant transaction blocking. Your financial security is our top priority with 24/7 monitoring.</p>
        <button class="bg-blue-300 text-blue-900 px-4 py-2 rounded-lg  hover:bg-blue-400"onClick={() => window.location.href = '/security'}>Security Features</button>
      </div>
  ...
  <div class="px-4 mx-auto max-w-7xl">
    <div class="text-center">
      <h3 class="text-blue-400 font-bold text-3xl">ClickSafe Cards for secure payments.</h3>
    </div>
    </div>
  ...
  <div class="relative flex flex-col p-6 gap-4 rounded-2xl bg-cover bg-center overflow-hidden h-full min-h-[300px]">
    ...
    <h2 class="text-xl text-blue-900 font-bold z-10">Global Acceptance</h2>
    <p class="z-10 text-blue-900">Accepted at millions of locations worldwide with real-time currency conversion.</p>
    <button class="bg-blue-300 p-4 text-blue-900 px-4 py-2 w-fit rounded-lg z-10 hover:bg-blue-400" onClick={() => window.location.href = '/global'}>See more</button>
  </div>
  <div class="relative flex flex-col p-6 gap-4 rounded-2xl bg-cover bg-center overflow-hidden h-full min-h-[300px]">
    <img src={secure} alt="card image" class="absolute inset-0 w-full h-full object-cover opacity-20 rounded-2xl" decoding="async" />
    <h2 class="text-xl text-blue-900 font-bold z-10">Instant Alerts</h2>
    <p class="z-10 text-blue-900">Add your card to Apple Pay, Google Pay, and Samsung Pay.</p>
    <button class="bg-blue-300 p-4 text-blue-900 px-4 py-2 w-fit rounded-lg z-10 hover:bg-blue-400" onClick={() => window.location.href = '/alerts'}>See more</button>
  </div>
  <div class="relative flex flex-col p-6 gap-4 rounded-2xl bg-cover bg-center overflow-hidden h-full min-h-[300px]">
    <img src={secure} alt="card image" class="absolute inset-0 w-full h-full object-cover opacity-20 rounded-2xl" decoding="async" />
    <h2 class="text-xl text-blue-900 font-bold z-10">Digital Wallet Integration</h2>
    <p class="z-10 text-blue-900">Real-time notifications for every transaction on your card.</p>
    <button class="bg-blue-300 p-4 text-blue-900 px-4 py-2 w-fit rounded-lg z-10 hover:bg-blue-400" onClick={() => window.location.href = '/wallet'}>See more</button>
  </div>
  <div class="relative flex flex-col p-6 gap-4 rounded-2xl bg-cover bg-center overflow-hidden h-full min-h-[300px]">
    <img src={secure2} alt="card image" class="absolute inset-0 w-full h-full object-cover opacity-20 rounded-2xl" decoding="async" />
    <h2 class="text-xl text-blue-900 font-bold z-10">Card Controls</h2>
    <p class="z-10 text-blue-900">Freeze/unfreeze, set spending limits, and manage locations.</p>
    <button class="bg-blue-300 p-4 text-blue-900 px-4 py-2 w-fit rounded-lg z-10 hover:bg-blue-400" onClick={() => window.location.href = '/controls'}>See more</button>
  </div>
</div>
</section>
<section id="features" class="flex flex-col items-center justify-center gap-10 mt-4 p-10 bg-gray-100 w-full text-center">
  <h2 class="text-3xl font-extrabold text-blue-900">Why <span class='text-blue-400'>choose</span> ClickSafe?</h2>
  ...
  <img src={badge} alt="Zero fraud liability badge" class="rounded-2xl" decoding="async" />
      <h3 class="text-xl font-bold text-blue-400 mb-2">Zero Fraud Liability</h3>
  ...
  <img src={badge} alt="card" class="rounded-2xl" decoding="async" />
      <h3 class="text-xl font-bold text-blue-400 mb-2">No Annual Fees</h3>
      <p class="text-blue-900 text-sm leading-relaxed">Premium card benefits without the premium price tag.</p>
    </div>

    <div class="flex flex-col items-center p-6 w-80">
  <img src={badge} alt="card" class="rounded-2xl" decoding="async" />
      <h3 class="text-xl font-bold text-blue-400 mb-2">Spending Analytics</h3>
  ...
  <div class="mx-auto px-4 pb-6 max-w-24xl">
    <div class="grid grid-cols-5 gap-8 text-blue-900">
      <a class="flex items-center">
      <svg class="h-18 text-blue-900 hover:text-blue-400" viewBox="0 0 86 29" fill="currentColor"
...
<div class="flex items-center justify-center text-blue-900 bg-gray-100 p-10 m-5">
    ...
    <div class="grid grid-cols-1 gap-8">
      <div class="flex flex-col items-center">
        ...
        <div class="mt-6 flex flex-wrap gap-6 w-fit"> 
          <a href="get-cards#" class="p-3 rounded-lg grow border border-gray-300 w-fit text-blue-900 font-bold text-center hover:bg-blue-400">Order Cards</a>
          <a href="more-cards#" class="p-3 rounded-lg grow w-fit text center text-blue-900 bg-blue-300 hover:bg-blue-400">Compare Cards</a>
        </div>
      </div>
      <div class="relative flex items-center">
        <div class="relative p-4 text-center grow rounded-xl">
          <h2 class="text-2xl font-bold text-blue-400 ">Cardholder <span class='text-blue-900'>Testimonial</span></h2>
          <blockquote class="mt-6 pl-6 text-2xl text-blue-900 italic">
    ...
    <form onSubmit={handleFormSubmit} class="w-full md:w-1/2 bg-gray-100 rounded-lg shadow p-4 mb-8">
      <div class="w-full p-2">
        ...
        <div class="mb-4">
              ...
              <button type="submit" class="bg-blue-300 text-blue-900 py-3 px-8 rounded-lg text-lg font-medium hover:bg-blue-400">
                Send
              </button>
      </div>
    ...
    <div class="w-full md:w-1/2">
      <section class="relative rounded-lg pt-4 mb-8 bg-white shadow">
        <div class="absolute px-2 top-0 left-0 rounded-tl-lg rounded-br-lg bg-blue-300 p-4">
          <h5 class="text-blue-900 px-2 font-semibold text-md">ClickSafe Support</h5>
        </div>
          ...
          <div class="w-full flex justify-end my-3">
            <button class="px-4 py-2 text-blue-900 bg-blue-300 font-bold rounded-md hover:bg-blue-400">Chat Now</button>
          </div>
        </div>
      </section>  
    </div>
...
<section id="faq" class="bg-gray-100 py-18 px-2 mx-auto max-w-5xl">
  <div class="px-4 mx-auto max-w-7xl">
    <div class="text-center mx-auto max-w-2xl">
      ...
      <p class="text-blue-900 max-w-2xl mx-auto leading-relaxed">Hints to common questions about ClickSafe cards.</p>
    </div>
    <div class="space-y-4">
              <div class="bg-blue-300 rounded-lg p-4">
                <button type="button" id="faq1"
                  class="w-full text-left text-xl font-bold text-blue-900"
                  onClick={() => toggleFaq(1)}
                >
                  What is ClickSafe?
                </button>
                {faqOpen[1] && (
                  <p class="mt-2 text-blue-900">ClickSafe offers smart banking cards with advanced security features for safe and convenient transactions.</p>
                )}
              </div>
              <div class="bg-blue-300 rounded-lg p-4">
                ...
                {faqOpen[2] && (
                  <p class="mt-2 text-blue-900">Visit our order page to apply for a ClickSafe card. Choose your card type and fill out the application form.</p>
                )}
              </div>
              <div class="bg-blue-300 rounded-lg p-4">
                <button type="button" id="faq3"
                  ...
                  onClick={() => toggleFaq(3)}
                >
                  <span class="flex justify-between text-lg font-semibold text-blue-900 overflow-hidden">What are the security features?</span>  <svg id="arrow1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        class="w-6 h-6 text-blue-900">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
                {faqOpen[3] && (
                  <p class="mt-2 text-blue-900">Our cards include military-grade encryption, real-time fraud monitoring, instant alerts, and card controls.</p>
                )}
              </div>
            </div>
          </div>
